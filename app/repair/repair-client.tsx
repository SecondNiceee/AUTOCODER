        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200/50 rounded-2xl p-8 sm:p-10 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="prose prose-lg max-w-none relative z-10">
              ...
              <h2 className="text-2xl font-bold text-black mb-4">{t("repair_services_title", language)}</h2>

              <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed mb-6">
                <li>{t("repair_service1", language)}</li>
                <li>{t("repair_service2", language)}</li>
                <li>{t("repair_service3", language)}</li>
                <li>{t("repair_service4", language)}</li>
                <li>{t("repair_service5", language)}</li>
                <li>{t("repair_service6", language)}</li>
                <li>{t("repair_service7", language)}</li>
                <li>{t("repair_service8", language)}</li>
              </ul>

              <h2 className="text-2xl font-bold text-black mb-4">{t("repair_process_title", language)}</h2>

              <p className="text-gray-700 leading-relaxed mb-6">{t("repair_process_intro", language)}</p>

              <ol className="list-decimal list-inside space-y-2 text-gray-700 leading-relaxed mb-6">
                <li>{t("repair_step1", language)}</li>
                <li>{t("repair_step2", language)}</li>
                <li>{t("repair_step3", language)}</li>
                <li>{t("repair_step4", language)}</li>
              </ol>

              <h2 className="text-2xl font-bold text-black mb-4">{t("repair_sync_title", language)}</h2>
