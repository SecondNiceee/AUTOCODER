...
export const metadata: Metadata = {
  ...
  description: 'Doposażenie samochodów Mercedes, BMW, VAG w Poznaniu. Kamera 360, ambient, CarPlay, HUD, distronic, keyless. Retrofit na poziomie fabrycznym.',
  keywords: ['retrofit', 'doposażenie', 'kamera 360', 'ambient', 'CarPlay', 'HUD', 'distronic', 'keyless', 'ретрофит', 'дооснащение'],
  openGraph: {
            ...
            <div className="prose prose-lg max-w-none relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {Array.from({ length: 27 }, (_, i) => i + 1).map((num) => (
                  <div key={num} className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-4 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
