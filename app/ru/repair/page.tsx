...
export const metadata: Metadata = {
  ...
  description: 'Profesjonalna naprawa elektroniki samochodowej Mercedes, BMW, VAG w Poznaniu. Naprawa ECU, TCU, modułów sterujących. Synchronizacja komponentów.',
  keywords: ['naprawa elektroniki', 'naprawa ECU', 'naprawa TCU', 'naprawa modułów', 'elektronika Mercedes', 'elektronika BMW', 'ремонт электроники'],
  openGraph: {
    title: 'Naprawa Elektroniki Samochodowej | ECU, TCU | Autocoder Poznań',
    description: 'Profesjonalna naprawa elektroniki samochodowej Mercedes, BMW, VAG. Naprawa ECU, TCU, modułów sterujących.',
    url: `${SITE_URL}/repair`,
  },
  alternates: {
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200/50 rounded-2xl p-8 sm:p-10 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="prose prose-lg max-w-none relative z-10">
              <p className="text-gray-700 leading-relaxed mb-6">
                {t('repair_intro1', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">
                {t('repair_intro2', language)}
              </p>

              <p className="text-[oklch(0.65_0.18_130)] font-semibold text-xl mb-6">
                {t('repair_intro3', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('repair_intro4', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">
                {t('repair_intro5', language)}
              </p>
              ...
              <div className="space-y-6 mb-8">
                <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
                  <h3 className="text-[oklch(0.65_0.18_130)] font-semibold text-lg mb-3">{t('repair_type1_title', language)}</h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('repair_type1_text', language)}
                  </p>
                </div>

                <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
                  <h3 className="text-[oklch(0.65_0.18_130)] font-semibold text-lg mb-3">{t('repair_type2_title', language)}</h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('repair_type2_text', language)}
                  </p>
                </div>
              </div>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('repair_diagnosis', language)}
              </p>

              <div className="bg-[oklch(0.65_0.18_130)]/10 border border-[oklch(0.65_0.18_130)]/30 rounded-xl p-6 mb-8">
                <p className="text-gray-700 leading-relaxed mb-4">
                  {t('repair_replacement1', language)}
                </p>
                <p className="text-gray-700 leading-relaxed">
                  {t('repair_replacement2', language)}
                </p>
              </div>

              <p className="text-gray-700 leading-relaxed text-center italic text-lg">
                {t('repair_sync', language)}
              </p>
            </div>
          </div>
        </div>
