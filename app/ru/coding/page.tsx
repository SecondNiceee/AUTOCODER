...
export const metadata: Metadata = {
  ...
  description: 'Profesjonalne kodowanie i programowanie samochodów Mercedes, BMW, VAG w Poznaniu. Aktywacja funkcji, retrofit, adaptacja modułów. Sprzęt dealerski.',
  keywords: ['kodowanie samochodów', 'programowanie ECU', 'kodowanie Mercedes', 'kodowanie BMW', 'VCDS', 'ODIS', 'кодирование автомобилей'],
  openGraph: {
    title: 'Kodowanie i Programowanie Samochodów | Autocoder Poznań',
    description: 'Profesjonalne kodowanie i programowanie samochodów Mercedes, BMW, VAG. Aktywacja funkcji, retrofit, adaptacja modułów.',
    url: `${SITE_URL}/coding`,
  },
  alternates: {
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200/50 rounded-2xl p-8 sm:p-10 md:p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="prose prose-lg max-w-none relative z-10">
              <p className="text-gray-700 leading-relaxed mb-6">
                {t('coding_intro1', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('coding_intro2', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-10">
                {t('coding_intro3', language)}
              </p>

              {/* Programming Section */}
              <h2 className="text-3xl font-bold text-[oklch(0.65_0.18_130)] mb-6 mt-10">{t('programming_title', language)}</h2>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('programming_intro', language)}
              </p>
              ...
              <div className="space-y-6 mb-10">
                <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
                  <h3 className="text-[oklch(0.65_0.18_130)] font-semibold text-lg mb-3">{t('programming_1_title', language)}</h3>
                  <p className="text-gray-700 leading-relaxed">
                    {t('programming_1_text', language)}
                  </p>
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-3">
                    {t('programming_2_text', language)}
                  </p>
                  <p className="text-gray-600 text-sm italic">
                    {t('programming_2_example', language)}
                  </p>
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-xl p-6 hover:border-[oklch(0.65_0.18_130)]/50 transition-colors duration-300 shadow-md">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-3">
                    {t('programming_3_text1', language)}
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-3">
                    {t('programming_3_text2', language)}
                  </p>
                  <p className="text-gray-600 text-sm italic">
                    {t('programming_3_example', language)}
                  </p>
                </div>
              </div>

              {/* Coding Section */}
              <h2 className="text-3xl font-bold text-[oklch(0.65_0.18_130)] mb-6 mt-12">{t('coding_section_title', language)}</h2>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('coding_intro', language)}
              </p>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                {t('coding_sync1', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">
                {t('coding_sync2', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">
                {t('coding_sync3', language)}
              </p>

              <p className="text-gray-700 leading-relaxed mb-8">
                {t('coding_sync4', language)}
              </p>

              <p className="text-gray-700 leading-relaxed">
                {t('coding_extra', language)}
              </p>
            </div>
          </div>
        </div>
