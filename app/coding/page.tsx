...
import CodingPageClient from "./coding-client"
...
export const metadata: Metadata = {
  ...
  keywords: ["kodowanie samochodów", "programowanie ECU", "kodowanie Mercedes", "kodowanie BMW", "VCDS", "ODIS"],
  openGraph: {
    ...
    url: `${SITE_URL}/pl/coding`,
  },
  alternates: {
    canonical: `${SITE_URL}/pl/coding`,
  },
}

export default function CodingPage() {
  return <CodingPageClient />
}
